                         ...
                         <div class="wrap">
                             <div class="main">
                                 <strong class="subject">
                                     <a href="./questions/detail?questionId=${question.id}">${question.title}</a>
                                 </strong>
                                 <div class="auth-info">
                                     <i class="icon-add-comment"></i>
                                     <span class="time"><fmt:formatDate value="${question.createdDate}" pattern="yyyy-MM-dd HH:mm" /></span>
